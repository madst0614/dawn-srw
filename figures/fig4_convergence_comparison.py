...
Usage:
    ...
    python figures/fig4_convergence_comparison.py \\
    ...
    python figures/fig4_convergence_comparison.py --demo

Output:
    figures/fig4_convergence_comparison.pdf
    figures/fig4_convergence_comparison.png
...
Examples:
    ...
    parser.add_argument('--output', type=str, default='figures/fig4_convergence_comparison',
                       help='Output path without extension (default: figures/fig4_convergence_comparison)')
